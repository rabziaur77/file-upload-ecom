...
import DropDownSelectList from "../Covers/CoverDropdownData";
import BackCoverContentLogic from "./BackCoverContentLogic";

const BackCoverContent = ({ initialData }) => {
  const { formData, handleChange, handleFileChange, handleSubmit } = BackCoverContentLogic(initialData);

  return (
    <div>
      <h1 className="h2 border-bottom pb-2">{initialData != undefined ? "Edit Back" : "Add New Back"} Cover</h1>
...
export default BackCoverContent;
