...
function BackCoverContentLogic(initialData = null) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      var URL = "";
      if (initialData === null) {
            URL = "/api/MobileBackCovers/AddCover";
        }
        else{
            URL = "/api/MobileBackCovers/UpdateCover";
        }
...
export default BackCoverContentLogic;
